...
inline Image_Format translate_vkformat_to_image_format(VkFormat vk_format)
{
    ...
    case VK_FORMAT_BC1_RGB_UNORM_BLOCK:      return Image_Format::BC1_RGB_UNORM_BLOCK;
    case VK_FORMAT_BC1_RGB_SRGB_BLOCK:       return Image_Format::BC1_RGB_SRGB_BLOCK;
    case VK_FORMAT_BC1_RGBA_UNORM_BLOCK:     return Image_Format::BC1_RGBA_UNORM_BLOCK;
    case VK_FORMAT_BC1_RGBA_SRGB_BLOCK:      return Image_Format::BC1_RGBA_SRGB_BLOCK;
    case VK_FORMAT_BC2_UNORM_BLOCK:          return Image_Format::BC2_UNORM_BLOCK;
    case VK_FORMAT_BC2_SRGB_BLOCK:           return Image_Format::BC2_SRGB_BLOCK;
    case VK_FORMAT_BC3_UNORM_BLOCK:          return Image_Format::BC3_UNORM_BLOCK;
    case VK_FORMAT_BC3_SRGB_BLOCK:           return Image_Format::BC3_SRGB_BLOCK;
    case VK_FORMAT_BC4_UNORM_BLOCK:          return Image_Format::BC4_UNORM_BLOCK;
    case VK_FORMAT_BC4_SNORM_BLOCK:          return Image_Format::BC4_SNORM_BLOCK;
    case VK_FORMAT_BC5_UNORM_BLOCK:          return Image_Format::BC5_UNORM_BLOCK;
    case VK_FORMAT_BC5_SNORM_BLOCK:          return Image_Format::BC5_SNORM_BLOCK;
    case VK_FORMAT_BC6H_UFLOAT_BLOCK:        return Image_Format::BC6H_UFLOAT_BLOCK;
    case VK_FORMAT_BC6H_SFLOAT_BLOCK:        return Image_Format::BC6H_SFLOAT_BLOCK;
    case VK_FORMAT_BC7_UNORM_BLOCK:          return Image_Format::BC7_UNORM_BLOCK;
    case VK_FORMAT_BC7_SRGB_BLOCK:           return Image_Format::BC7_SRGB_BLOCK;
    default:
        std::unreachable();
    }
}
